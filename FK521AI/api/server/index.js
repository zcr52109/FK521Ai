...
const { validateServerRuntimeContracts } = require('./services/start/runtimeContracts');
...
} = require('./services/DownloadLinks');
const { assertSandboxContractSecretConfigured } = require('./services/Sandbox/runtimeContract');
...
const startServer = async () => {
  ...
  const corsOptions = {
    origin: process.env.CORS_ORIGIN ? process.env.CORS_ORIGIN.split(',') : ['http://localhost:3080', 'http://localhost:5173'],
...
/** Export app/startServer for easier testing purposes */
module.exports = {
  app,
  startServer,
};
